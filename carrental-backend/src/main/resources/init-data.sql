...
INSERT IGNORE INTO cities (name, state, latitude, longitude, delivery_fee_per_km, created_at) VALUES
('All', 'All', 0, 0, 0, NOW()),
...
INSERT IGNORE INTO vehicle_categories (name, description, created_at) VALUES
...
INSERT IGNORE INTO users (email, password, first_name, last_name, phone_number, role, created_at) VALUES
...
INSERT IGNORE INTO vehicles (registration_number, make, model, year, category_id, city_id, admin_id, status, daily_rate, weekly_rate, monthly_rate, color, fuel_type, transmission, seating_capacity, mileage, insurance_valid_till, registration_valid_till, created_at) VALUES
